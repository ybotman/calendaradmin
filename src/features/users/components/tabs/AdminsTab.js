 ...
 * @returns {JSX.Element} AdminsTab component
 */
export default function AdminsTab({ value, index, onEditUser, onDeleteUser }) {
  ...
  const { adminColumns } = createColumnDefinitions({
