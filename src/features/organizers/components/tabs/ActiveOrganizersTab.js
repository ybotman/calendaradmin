...
/**
 * Component for the Active Organizers tab
 * 
 ...
 * @returns {JSX.Element} ActiveOrganizersTab component
 */
export default function ActiveOrganizersTab({ value, index, onEditOrganizer, onDeleteOrganizer }) {
