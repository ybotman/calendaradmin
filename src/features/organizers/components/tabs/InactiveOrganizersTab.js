...
/**
 * Component for the Inactive Organizers tab
 * 
 ...
 * @returns {JSX.Element} InactiveOrganizersTab component
 */
export default function InactiveOrganizersTab({ value, index, onEditOrganizer, onDeleteOrganizer }) {
